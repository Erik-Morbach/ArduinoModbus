...
int ModbusRTUServerClass::begin(int id, unsigned long baudrate,void *serialType, uint16_t config)
{
  modbus_t* mb = modbus_new_rtu(baudrate, config,serialType);
...
void ModbusRTUServerClass::poll(void *resetVar, int nb)
{
